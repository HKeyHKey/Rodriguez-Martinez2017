...
puce_array1=165350205
puce_array2=168238305
puce_array3=168239805
name_array1='2-40_cells_replicate1'
name_array2='2-40_cells_replicate2'
name_array3='2-40_cells_replicate3'
analysis='2_40_cells'
...
array2 <- format.data(puce_array2, export = FALSE, design = pos_file)
array3 <- format.data(puce_array3, export = FALSE, design = pos_file)
...
plot.data(array2, type = "Avant normalisation")
plot.data(array3, type = "Avant normalisation")
...
array2 <- norma.lowess(array2,puce_array2, plot = TRUE, export = FALSE)
array3 <- norma.lowess(array3,puce_array3, plot = TRUE, export = FALSE)
...
plot.data(array2 , type = "Apres normalisation Lowess")
plot.data(array3 , type = "Apres normalisation Lowess")
...
export.gff(array2, data.M = "M.NORM")
export.gff(array3, data.M = "M.NORM")
...
write.table(array2, file = paste("Data/",name_array2,".txt",sep=''), quote=FALSE, sep="\t", row.names=FALSE, col.names=TRUE)
write.table(array3, file = paste("Data/",name_array3,".txt",sep=''), quote=FALSE, sep="\t", row.names=FALSE, col.names=TRUE)
