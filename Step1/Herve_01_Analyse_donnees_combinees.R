...
ech2.Mixc <- read.table("Data_ce6_res/ech2.Mixc.55236901.minus.control.neg.txt", sep="\t", dec=".", header=TRUE)
...
names(ech2.Mixc) <- c("PROBE_ID","CHROMOSOME", "POSITION","END","LENGTH","A.NORM.neg","M.NORM.neg","A.NORM.ech2","M.NORM.ech2","M.NORM.minus.neg","M.NORM.minus.neg.w5")
...
# --- Embryons 2-40 cellules  --- #
## 40a.40b ##							 
ech2.40a.40b.2rep <- analyse.replicats.eBayes(ech2.40a, ech2.40b,
				   			nom.rep1 = "ech2.40a", nom.rep2 = "ech2.40b",
...
## 40a.40c ##	
ech2.40a.40c.2rep <- analyse.replicats.eBayes(ech2.40a, ech2.40c,
				   			nom.rep1 = "ech2.40a", nom.rep2 = "ech2.40c",
				   			data.M = "M.NORM.minus.neg.w5", data.A="A.NORM.ech2", method.between.array ="scale", adjust = TRUE, lower.tail=FALSE, vect.col=vect.col.ech2)

## 40b.40c ##	
ech2.40b.40c.2rep <- analyse.replicats.eBayes(ech2.40b,ech2.40c,
				   			nom.rep1 = "ech2.40b", nom.rep2 = "ech2.40c",
				   			data.M = "M.NORM.minus.neg.w5", data.A="A.NORM.ech2", method.between.array ="scale", adjust = TRUE, lower.tail=FALSE, vect.col=vect.col.ech2)
...
## Mixa.Mixc ##	
ech2.Mixa.Mixc.2rep <- analyse.replicats.eBayes(ech2.Mixa, ech2.Mixc,
				   			nom.rep1 = "ech2.Mixa", nom.rep2 = "ech2.Mixc",
				   			data.M = "M.NORM.minus.neg.w5", data.A="A.NORM.ech2", method.between.array ="scale", adjust = TRUE, lower.tail=FALSE, vect.col=vect.col.ech2)

## Mixb.Mixc ##	
ech2.Mixb.Mixc.2rep <- analyse.replicats.eBayes(ech2.Mixb,ech2.Mixc,
				   			nom.rep1 = "ech2.Mixb", nom.rep2 = "ech2.Mixc",
				   			data.M = "M.NORM.minus.neg.w5", data.A="A.NORM.ech2", method.between.array ="scale", adjust = TRUE, lower.tail=FALSE, vect.col=vect.col.ech2)

## Mixa.Mixb.Mixc ##
ech2.Mixa.Mixb.Mixc.3rep <- analyse.replicats.eBayes(ech2.Mixa, ech2.Mixb, ech2.Mixc,
				   			nom.rep1 = "ech2.Mixa", nom.rep2 = "ech2.Mixb", nom.rep3 = "ech2.Mixc",
				   			data.M = "M.NORM.minus.neg.w5", data.A="A.NORM.ech2", method.between.array ="scale", adjust = TRUE, lower.tail=FALSE, vect.col=vect.col.ech2)
...
# --- Embryons 2-40 cellules  --- #
export.gff(ech2.40a.40b.2rep, data.M = "M.comb.eBayes")
export.gff(ech2.40a.40c.2rep, data.M = "M.comb.eBayes")
export.gff(ech2.40b.40c.2rep, data.M = "M.comb.eBayes")
export.gff(ech2.40a.40b.40c.3rep, data.M = "M.comb.eBayes")
# --- Embryons Mix  --- #
export.gff(ech2.Mixa.Mixb.2rep, data.M = "M.comb.eBayes")
export.gff(ech2.Mixa.Mixc.2rep, data.M = "M.comb.eBayes")
export.gff(ech2.Mixb.Mixc.2rep, data.M = "M.comb.eBayes")
export.gff(ech2.Mixa.Mixb.Mixc.3rep, data.M = "M.comb.eBayes")


# --- Embryons 2-40 cellules  --- #

export.gff(ech2.40a.40b.2rep, data.M = "M.comb.eBayes", pval = "pval.comb.eBayes.adj", seuil = 0.05)
export.gff(ech2.40a.40c.2rep, data.M = "M.comb.eBayes", pval = "pval.comb.eBayes.adj", seuil = 0.05)
export.gff(ech2.40b.40c.2rep, data.M = "M.comb.eBayes", pval = "pval.comb.eBayes.adj", seuil = 0.05)
...
export.gff(ech2.Mixa.Mixc.2rep, data.M = "M.comb.eBayes", pval = "pval.comb.eBayes.adj", seuil = 0.05)
export.gff(ech2.Mixb.Mixc.2rep, data.M = "M.comb.eBayes", pval = "pval.comb.eBayes.adj", seuil = 0.05)
export.gff(ech2.Mixa.Mixb.Mixc.3rep, data.M = "M.comb.eBayes", pval = "pval.comb.eBayes.adj", seuil = 0.05)
...
write.table(ech2.40a.40b.2rep, file = "Data_comb/ech2.40a.40b.2rep.txt", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
write.table(ech2.40a.40c.2rep, file = "Data_comb/ech2.40a.40c.2rep.txt", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
write.table(ech2.40b.40c.2rep, file = "Data_comb/ech2.40b.40c.2rep.txt", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
...
write.table(ech2.Mixa.Mixc.2rep, file = "Data_comb/ech2.Mixa.Mixc.2rep.txt", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
write.table(ech2.Mixb.Mixc.2rep, file = "Data_comb/ech2.Mixb.Mixc.2rep.txt", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
write.table(ech2.Mixa.Mixb.Mixc.3rep, file = "Data_comb/ech2.Mixa.Mixb.Mixc.3rep.txt", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
